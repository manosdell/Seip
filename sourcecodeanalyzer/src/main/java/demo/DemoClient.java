...
public class DemoClient {
    ...
    public static void main(String[] args) throws IOException {
		...
		codeanalyzer.CodeAnalyzerFacade analyzer = new CodeAnalyzerFacade();
		analyzer.analyze(filepath, sourceFileLocation, sourceCodeAnalyzerType, outputFilePath, outputFileType);
	}
